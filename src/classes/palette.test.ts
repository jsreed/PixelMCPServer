...
describe('PaletteClass', () => {
    ...
    it('set validates index bounds', () => {
        ...
        expect(() => { palette.set(-1, [255, 255, 255, 255]); }).toThrow();
        expect(() => { palette.set(256, [255, 255, 255, 255]); }).toThrow();
        expect(() => { palette.set(1.5, [255, 255, 255, 255]); }).toThrow();
    });
    ...
    it('set validates color values', () => {
        ...
        expect(() => { palette.set(5, invalidValues1); }).toThrow();
        expect(() => { palette.set(5, invalidValues2); }).toThrow(); // missing alpha
    });
