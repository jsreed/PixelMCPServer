...
declare module 'gifenc' {
     ...
     */
    export function prequantize(rgba: Uint8Array | Uint8ClampedArray, opts?: PrequantizeOptions): void;
     ...
     */
    export function applyPalette(rgba: Uint8Array | Uint8ClampedArray, palette: Palette, format?: QuantizeFormat): Uint8Array;
     ...
     */
    export function nearestColorIndex(colors: Palette, pixel: number[], distanceFn?: DistanceFunction): number;

    /**
     * Find the nearest color in a palette.
     * @returns The nearest color entry.
     */
    export function nearestColor(colors: Palette, pixel: number[], distanceFn?: DistanceFunction): number[];

    /**
     * Find the nearest color index and its squared distance.
     * @returns [index, distanceSquared]
     */
    export function nearestColorIndexWithDistance(colors: Palette, pixel: number[], distanceFn?: DistanceFunction): [number, number];
